...
export interface components {
  schemas: {
    ...
    PageDtoPostListDto: {
      ...
      /** Format: int32 */
      number: number;
      content: components["schemas"]["PostListDto"][];
      hasPrevious: boolean;
      hasNext: boolean;
    };
    PostListDto: {
    ...
    RsDataPageDtoPostListDto: {
      resultCode: string;
      msg: string;
      data: components["schemas"]["PageDtoPostListDto"];
      /** Format: int32 */
      statusCode: number;
      fail: boolean;
      success: boolean;
    };
    RsDataListPostListDto: {
      resultCode: string;
      msg: string;
      data: components["schemas"]["PostListDto"][];
      /** Format: int32 */
      statusCode: number;
      fail: boolean;
      success: boolean;
...
export interface operations {
  ...
  getMyPosts: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["RsDataPageDtoPostListDto"];
        };
      };
      /** @description Internal Server Error */
      500: {
  ...
  getLatestPosts: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["RsDataListPostListDto"];
        };
      };
      /** @description Internal Server Error */
      500: {
